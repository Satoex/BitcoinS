...
{
    const char* pszTimestamp = "BitcoinStaking 16-MARCH-2021 PoS and The Roadmap To Monetary Freedom";
...
public:
    CMainParams() {
        ...
        consensus.BPSRewardMatchHeight = consensus.BPSRewardMatchStep;
        consensus.BPSDiffAdjHeight = 6000;
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.posLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 10 * 10 * 60; // every 10 blocks
        ...
        // time: 1615918852
        // consensus.hashGenesisBlock: 00000fab5d4d09dce49f6713ef227e122022eb7f2627b22b9c3f28c75c5836e6
        // genesis.hashMerkleRoot: f3104b1d57d0ec464bc9b66a2edc6ccf7d9dabb6d8ddcce5e43b90098867f8c8
        // genesis.nNonce: 2273270

        uint32_t nTime=1615918852;
        uint32_t nNonce=2273270; 
        genesis = CreateGenesisBlock(nTime, nNonce, 0x1e0fffff, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000fab5d4d09dce49f6713ef227e122022eb7f2627b22b9c3f28c75c5836e6"));
        assert(genesis.hashMerkleRoot == uint256S("0xf3104b1d57d0ec464bc9b66a2edc6ccf7d9dabb6d8ddcce5e43b90098867f8c8"));
        ...
        checkpointData = {
            {
                {           0, uint256S("0x00000fab5d4d09dce49f6713ef227e122022eb7f2627b22b9c3f28c75c5836e6")},
                {        5000, uint256S("0x000000f9b1c86845bedc9b8ad5890022dc9a8c19ec24c22f49d003681d3a0935")},                
            }
        };
